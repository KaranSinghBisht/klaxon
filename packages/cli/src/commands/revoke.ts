...
import { loadProjectContext, persistProject, witnessFor } from "../context.js";
...
/**
 * The panic button. It is operator-signed rather than device-signed on purpose: revocation has to
...
export function makeRevokeCommand(deps: CliDeps): Command {
  return new Command("revoke")
    .description("stop all releases for a project (operator-signed, no device)")
