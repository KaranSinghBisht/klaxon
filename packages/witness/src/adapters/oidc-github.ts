 ...
 *
 * Both paths run under a deadline: check 2 sits on the release critical path, and a JWKS fetch
 * that hangs would hold the request open for undici's five-minute default (D9 timeouts).
 */
